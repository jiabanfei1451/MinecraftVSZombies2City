...
/// 着色器资源加载器
/// </summary>
public static class ResourceShader
{
    /// <summary>
    /// 已加载的资源
    /// </summary>
    public static Godot.Collections.Array<Shader> Load_Scene = new Godot.Collections.Array<Shader>();
    /// <summary>
    /// 资源路径
    /// </summary>
